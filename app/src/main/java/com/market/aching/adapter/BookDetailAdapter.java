...
import com.market.aching.model.BookReviewResponse;
...
public class BookDetailAdapter extends RecyclerView.Adapter {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof BookInfoHolder) {
            ...
            ((BookInfoHolder) holder).tv_comment_num.setText(mBookInfo.getRating().getNumRaters() + BaseActivity.activity.getString(R.string.comment_num));
...
//                        }).sendEmptyMessageDelayed(0, getDelayTime());
            ...
            if (!mBookInfo.getSummary().isEmpty()) {
                ...
                ((BookBriefHolder) holder).etv_brief.setContent(BaseActivity.activity.getString(R.string.no_brief));
            }
                    ...
                    .into(new BitmapImageViewTarget(((BookCommentHolder) holder).iv_avatar) {
                        ...
                        protected void setResource(Bitmap resource) {
                            RoundedBitmapDrawable circularBitmapDrawable =
                                    RoundedBitmapDrawableFactory.create(BaseActivity.activity.getResources(), resource);
